...
<body>
  ...
  <div class="jumbotron">
    <div class="container">
      <h1>롯데홈쇼핑</h1>
      <p>
      <h3>'One Lotte'를 위해서 계열사의 통합서비스를 위한 반응형 웹 어플리케이션을 개발중입니다.</h3>
      </p>
      <p>
      ...
      <div class="col-lg-12">
        <h1 class="page-header">
          ...
          <div class="pull-right">
            <a href="/member/update?m_no=<%=member.getNo()%>" class="btn btn-primary" role="button">수정</a>
          </div>
        </h1>
      </div>
    </div>
    <div class="row">
      <div class="col-lg-12">
        <div class="panel panel-default">
          <div class="panel-heading">Basic Information about Member.</div>
              ...
              <div class="col-md-6 col-lg-6">
                <form action='' method='post'>
                  <div class="form-group">
                    <label>NO</label> <input type="text" class="form-control" name="id"
                      value="${member.no}" readonly>
                  </div>
                  <div class="form-group">
                    <label>ID</label> <input type="text" class="form-control" name="name"
                      value="${member.id}" readonly>
                  </div>
                  <div class="form-group">
                    <label>회원등급</label> <input type="text" class="form-control" name="name"
                  ...
                  <div class="form-group">
                    <label>EMAIL</label> <input type="text" class="form-control" name="name"
                      value="${member.email}" readonly>
                  </div>
                  <div class="form-group">
                    <label>휴대폰</label> <input type="text" class="form-control" name="name"
                      value="${member.phone}" readonly>
                  </div>
                  <div class="form-group">
                    <label>가입일</label> <input type="text" class="form-control" name="name"
                      value="${member.regist}" readonly>
                  </div>
                </form>
              </div>
              <div class="col-md-3 col-lg-3"></div>
