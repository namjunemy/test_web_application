            ...
            <div class="col-md-6 col-lg-6">
              <form action='' method='post'>
                <div class="form-group">
                  <label>NO</label>
                  <input type="text" class="form-control" name="id" value="${member.no}" readonly>
                </div>
                <div class="form-group">
                  <label>ID</label>
                  <input type="text" class="form-control" name="name" value="${member.id}" readonly>
                </div>
                <div class="form-group">
                  <label>회원등급</label>
                  <input type="text" class="form-control" name="name" value="${member.level}"
                         readonly>
                </div>
                <div class="form-group">
                  <label>이름</label>
                ...
                <div class="form-group">
                  <label>EMAIL</label>
                  <input type="text" class="form-control" name="name" value="${member.email}"
                         readonly>
                </div>
                <div class="form-group">
                  <label>휴대폰</label>
                ...
                <div class="form-group">
                  <label>가입일</label>
                  <input type="text" class="form-control" name="name" value="${member.regist}"
                         readonly>
                </div>
              </form>
            </div>
